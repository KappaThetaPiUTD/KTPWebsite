...
const Gallery = () => {
  ...
  const images = [
   ...
   // { src: 'https://res.cloudinary.com/dha44tosd/image/upload/v1714850367/Austin%20Trip/100_1547_krukpz.jpg', alt: 'Image 10' },
    ...
    { src: 'https://res.cloudinary.com/dha44tosd/image/upload/v1741148690/Gallery/IMG_5506_jwp21u.heic', alt: 'AWS Pres 1' },
    { src: 'https://res.cloudinary.com/dha44tosd/image/upload/v1741148714/Gallery/IMG_5517_yg2171.heic', alt: 'AWS Pres 2' },
    { src: 'https://res.cloudinary.com/dha44tosd/image/upload/v1741148715/Gallery/IMG_5523_djd7nm.heic', alt: 'AWS Pres 3' },
    { src: 'https://res.cloudinary.com/dha44tosd/image/upload/v1741148716/Gallery/IMG_5532_kjtadd.heic', alt: 'AWS Pres 4' },
    { src: 'https://res.cloudinary.com/dha44tosd/image/upload/v1741148718/Gallery/IMG_5680_uv7qbu.heic', alt: 'Halloween' },
