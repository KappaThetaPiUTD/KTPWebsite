...
const Hero = () => {
  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden">
      ...
      <div className="flex flex-col items-center gap-y-4 sm:gap-y-8 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 whitespace-nowrap font-poppins text-3xl sm:text-4xl md:text-6xl lg:text-7xl xl:text-8xl tracking-widest text-accent">
