// Single source of truth for KTP board rosters.
// Imported by the Brothers page (for display) and the chat API route (so the
// assistant can answer "who is the ... ?" questions accurately). Update here
// and both the site and the chatbot stay in sync.
...
export const directorBoardMembers = [
  {
    name: "Om Pansuriya",
  ...
  },
  {
    ...
    linkedin: "https://www.linkedin.com/in/pranav-cheedalla-3b18a628a",
  },
  {
    name: "Sanika Tripathi",
    position: "Director of Social Media",
    src: "https://res.cloudinary.com/dha44tosd/image/upload/v1783207291/Brother%20Page/Actives/sanika_tripathi.jpg",
    linkedin: "https://www.linkedin.com/in/sanika-tripathi/",
  },
  {
    name: "Simon Beyene",
  ...
  },
  {
    ...
    position: "Chief of Compliance",
    src: "https://res.cloudinary.com/dha44tosd/image/upload/v1783207291/Brother%20Page/Actives/ethan_philipose.jpg",
    linkedin: "",
  },
  {
    name: "Hemant Pacha",
    position: "Official KTP Photographer",
    src: "https://res.cloudinary.com/dha44tosd/image/upload/v1783207295/Brother%20Page/Actives/hemant_pacha.jpg",
    linkedin: "https://www.linkedin.com/in/hemantpacha/",
  },
];
